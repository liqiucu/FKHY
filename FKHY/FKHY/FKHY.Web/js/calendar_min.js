...
function get_calendar_tab(str_tr,first_day,now_year,now_month,now_day,prv_m,id_selected,now_month_days_num){
	      ...
	      if(flag == false){
	      	...
	      	if(date_str == now_day){
	      		if(id_selected!="calendar2"){
	      			html += "<td><div class=sjb clearfix style=display:none><ul class='lul'><li onclick='get_date_into_calendar($(this));'>7:30~8:30</li><li onclick='get_date_into_calendar($(this));'>8:30~9:30</li><li onclick='get_date_into_calendar($(this));'>9:30~10:30</li><li onclick='get_date_into_calendar($(this));'>10:30~11:30</li> <li onclick='get_date_into_calendar($(this));'>11:30~12:30</li> <li onclick='get_date_into_calendar($(this));'>12:30~13:30</li> <li onclick='get_date_into_calendar($(this));'>13:30~14:30</li><li onclick='get_date_into_calendar($(this));'>14:30~15:30</li><li onclick='get_date_into_calendar($(this));'>15:30~16:30</li><li onclick='get_date_into_calendar($(this));'>16:30~17:30</li><li onclick='get_date_into_calendar($(this));'>17:30~18:30</li></ul></div><a class=showsjb style='background:rgb(102, 190, 140);' href='javascript:void(0);' onclick=click_day($(this),"+now_year+","+now_month+","+date_str+");$('.showsjb').siblings().parent().find('div').css({display:'none'});$(this).prev().css({display:'block'})>"+date_str+"</a></td>";
	      		}else{
		      	...
		      	if(id_selected!="calendar2"){
		      		html += "<td><div class=sjb clearfix style=display:none><ul class='lul' ><li onclick='get_date_into_calendar($(this));'>7:30~8:30</li><li onclick='get_date_into_calendar($(this));'>8:30~9:30</li><li onclick='get_date_into_calendar($(this));'>9:30~10:30</li><li onclick='get_date_into_calendar($(this));'>10:30~11:30</li> <li onclick='get_date_into_calendar($(this));'>11:30~12:30</li><li onclick='get_date_into_calendar($(this));'>12:30~13:30</li> <li onclick='get_date_into_calendar($(this));'>13:30~14:30</li><li onclick='get_date_into_calendar($(this));'>14:30~15:30</li> <li onclick='get_date_into_calendar($(this));'>15:30~16:30</li><li onclick='get_date_into_calendar($(this));'>16:30~17:30</li> <li onclick='get_date_into_calendar($(this));'>17:30~18:30</li></ul></div><a class=showsjb href='javascript:void(0);' onclick=click_day($(this),"+now_year+","+now_month+","+date_str+");$('.showsjb').siblings().parent().find('div').css({display:'none'});$(this).prev().css({display:'block'});>"+date_str+"</a></td>";
		      	}else{
	...
	$("#"+id_selected).html(html);
			...
			$(".on1,.one2,.one3,.one4,.one5,.one6,.one7,.one8,.one9,.one10,.one11").click(function(){//如果没有触发mouseleave时间，点击其他菜单隐藏时间表
					$(".nicescroll-railss").css({display:"none"})
