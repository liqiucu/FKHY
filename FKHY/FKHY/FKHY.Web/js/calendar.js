...
(function(root, factory) {
    ...
    var defaults = {
        ...
        /*    height: 280,*/
            ...
            // 星期格式
            weekArray: ['일요일', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일'],
        ...
        DATE_DIS_TPL = '{year}/<span class="m">&nbsp&nbsp&nbsp{month}월</span>',

        ITEM_STYLE = 'style="width:{w}px;height:{h}px;line-height:{h}px"',
        WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + '>{wk}<i class="fgx"></i></li>',
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" id="lh" {action}>{value}<div class="sjb clearfix"style="display:none"><ul class="clearfix"><li>7:30~8:15</li><li>8:30~9:15</li><li>9:30~10:15</li><li>10:30~11:15</li> <li>11:30~12:15</li> <li>12:30~13:15</li> <li>13:30~14:15</li></ul></div></li>',
        ...
        TEMPLATE = [
            ...
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display" id="qxg">{yyyy}</a>',
            '<div class="calendar-arrow">',
